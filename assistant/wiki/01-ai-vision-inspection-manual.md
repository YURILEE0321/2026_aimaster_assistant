---
id: MANUAL-021
title: AI 비전 검사 시스템 사용자 매뉴얼
doc_type: 사용자 매뉴얼
category: AI 비전 검사 시스템
version: v1.0
created_date: 2026-07-02
updated_date: 2026-07-02
approval_status: pending
approved_by: null
tags: [비전검사, GOOD, DEFECT, 리뷰, AI모델, 설비관리, 신뢰도]
source_file: data/21 시스템 사용자 매뉴얼.md
related_menus: [설비관리, 이미지 조회, AI 평가, 리뷰, 모델관리]
summary: 생산 설비 이미지를 AI가 자동으로 양품(GOOD)/불량(DEFECT) 판정하고, 운영자가 리뷰를 통해 최종 판정을 확정하는 AI 비전 검사 시스템의 사용자 매뉴얼.
---
